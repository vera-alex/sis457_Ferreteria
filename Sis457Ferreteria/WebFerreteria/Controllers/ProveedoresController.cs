...
namespace WebFerreteria.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(LabFerreteriaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nit,RazonSocial,Direccion,Telefono,UsuarioRegistro,FechaRegistro,Estado")] Proveedor proveedor)
        {
            if (id != proveedor.Id)
            {
                return NotFound();
